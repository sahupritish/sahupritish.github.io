		...
		// Preloader
      	...
      	$(window).load(function() {
      		$(".preloader").fadeOut("slow", function(){
				...
				$('.hi .detail')
					.typeTo("I'm Pritish Sahu, graduate student at Rutgers University pursuing Masters in Computer Science. I prefer to swim, read novels and watch series during vacation.");
      		});
		});
